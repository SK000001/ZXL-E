...
#define M8_MAX_CANDS 32     // v13: 24 -> 32 (room for more hash chain hits)
#define M8_WALK_LIMIT 512
#define M8_HASH_BITS 18     // v13: 16 -> 18 (260K buckets reduces collisions)
#define M8_HASH_SIZE (1u << M8_HASH_BITS)
#define M8_CHAIN_K 32       // v13: 8 -> 32 deeper chain walk
...
int main(int argc, char **argv) {
    ...
    printf("---\n");
    printf("M8a v13(K32): %.4f  (%zu / %ld)\n", m8_ratio, zsize, n);
    printf("zstd-19     : %.4f  (%zu / %ld)\n", ref_ratio, ref_size, n);
    printf("delta       : %+.2f%% (M8a v13 vs zstd-19)\n", delta);
