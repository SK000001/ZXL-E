...
| **Crown-A bench (real-world corpus + freearc/kanzi/xtool)** | **shipped** — PyPI/npm/Docker/APK fixtures; kanzi & FreeArc lose everywhere, xtool beats us on 3 deflate-reproduction fixtures (−0.07% to −0.98%); zlib-param ladder + Go-deflate reproducer roadmap'd as the counters |
...
| real_requests.whl (PyPI wheel, pure-py) | — | **−21.19%** | — |
| real_pydantic_core.whl (PyPI wheel, native) | — | **−28.58%** | — |
| real_newpipe.apk (Android APK) | — | **−22.61%** | — |
